...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/drilldown.src.js', [_modules['parts/Color.js'], _modules['parts/Globals.js'], _modules['parts/Point.js'], _modules['parts/SVGRenderer.js'], _modules['parts/Tick.js'], _modules['parts/Utilities.js']], function (Color, H, Point, SVGRenderer, Tick, U) {
        /* *
         *
         *  Highcharts Drilldown module
         *
